...
public class Controller extends AbstractDataModel implements IDataModel,
  ...
  @XmlElement(name = "haz")
  private HazAccController hazController;
  ...
  public Controller() {
    ...
    this.hazController = new HazAccController();
  ...
  public void prepareForSave() {
    this.controlActionController.prepareForSave(new LinkController(), hazController);
