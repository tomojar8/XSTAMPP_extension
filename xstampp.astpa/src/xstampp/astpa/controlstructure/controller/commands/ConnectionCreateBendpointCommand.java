 ...
 *
 */
public final class ConnectionCreateBendpointCommand extends ControlStructureAbstractCommand {

  public ConnectionCreateBendpointCommand(UUID rootId, IControlStructureEditorDataModel model,
      String stepID) {
