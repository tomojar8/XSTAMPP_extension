 ...
 * therefore this class provides several functions to generate a Feedback Figure to visualize a
 * relation
 * 
 * @author Lukas Balzer
 * @since 2.0.2
...
public interface IRelativePart extends IControlStructureEditPart {
   ...
   *
   * @param member
   *          a component whioch implements IConnectable
   ...
   * 
   * @param member
   *          a edit of type IMemberEditPart which should be add to the set of members
   */
