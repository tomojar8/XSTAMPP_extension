...
public class ProvidedValuesCombi implements IValueCombie {
   ...
   *
   * @param values
   *          the list of process model variable ids
   */
  ...
  /**
   * @param hazardousAnyTime
   *          the hazardousAnyTime to set
   */
  ...
  /**
   * @param hazardousToLate
   *          the hazardousToLate to set
   */
  ...
  /**
   * @param hazardousToEarly
   *          the hazardousToEarly to set
   */
  ...
  /**
   * @param tooEarlyRuleId
   *          the tooEarlyRuleId to set
   */
