...
public interface IComponent {
   ...
   * argument <i>step0</i> if true than all process model components are excluded from the child
   * list
   * 
   * @param step0
   *          if false the control structure contains all components including the process Models
