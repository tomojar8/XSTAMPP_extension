...
public class RefinedSafetyRule extends AbstractLTLProvider {
  ...
  /**
   * @param refinedSafetyConstraint
   *          the refinedSafetyConstraint to set
   * @return
   */
  ...
  /**
   * @param criticalCombies
   *          the criticalCombies to set
   * @return
   */
