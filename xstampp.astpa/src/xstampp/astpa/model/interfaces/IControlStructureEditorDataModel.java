...
public interface IControlStructureEditorDataModel extends IDataModel {
   ...
   * @param index
   *          TODO
   * @return the id of the created component. Null when the component could not be added
   * 
   * @author Fabian Toth
   */
   ...
   * @author Fabian Toth
   */
  UUID addComponent(UUID controlActionId, UUID parentId, Rectangle layout, String text,
  ...
  /**
   * Synchronizes the layouts of all children drawn on the root from the 1. and 3. step
   * 
   * @author Lukas Balzer
   * 
   ...
   * @param componentId
   *          the id of the child
   * @return the component with the given id, null if the component does not exist
   * 
   * @author Fabian Toth
   */
  ...
  void setActiveRoot(UUID rootId);

  List<IRectangleComponent> getRoots();
  ...
  /**
   * Searches for the connection with the given id and changes the targetId to the new value<br>
   * Triggers an update for {@link org.extended.safetyproject.model.ObserverValue#CONTROL_STRUCTURE}
   * 
   * @param connectionId
   *          the id of the connection to change
   ...
   * @param connectionId
   *          the id of the connection
   * @return the connection with the given id, null if the connection does not exist
   * 
   * @author Fabian Toth
   */
  ...
  /**
   * Sets the path to the picture of the control structure with process model for the export
   * 
   * @author Fabian Toth
   * 
   * @param path
  ...
  /**
   * @param componentId
   *          the component which shall be related
   * @param relativeId
   *          the id of the relative to which the component should have a direct link
   * @author Lukas Balzer
   */
   ...
   *          the id of the component
   * @param variableID
   *          the variable which should be added
