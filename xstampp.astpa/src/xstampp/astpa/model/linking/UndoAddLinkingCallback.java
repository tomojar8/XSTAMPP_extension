...
public class UndoAddLinkingCallback implements IUndoCallback {
  ...
  public UndoAddLinkingCallback(LinkController linkController, LinkingType linkType,
      List<Link> links) {
  ...
  public UndoAddLinkingCallback(LinkController linkController, LinkingType linkType, Link link) {
