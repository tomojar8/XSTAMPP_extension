...
public class ControlStructurePreferences extends FieldEditorPreferencePage
  ...
  public void init(IWorkbench workbench) {
    ...
    setDescription(
        "Preferences for both the control structure and the control structure with process model editor");
  ...
  protected void createFieldEditors() {
    ...
    this.ConnectorSwitch = new BooleanFieldEditor(
        IControlStructureConstants.CONTROLSTRUCTURE_INDIVIDUAL_CONNECTIONS,
        "Activate manual connection mode",
        this.getFieldEditorParent());
    this.addField(this.ConnectorSwitch);

    this.ProcessModelBorderSwitch = new BooleanFieldEditor(
        IControlStructureConstants.CONTROLSTRUCTURE_PROCESS_MODEL_BORDER,
        "Show the border of the process Model Variables",
        this.getFieldEditorParent());
    this.addField(this.ProcessModelBorderSwitch);

    this.ListOfCABorderSwitch = new BooleanFieldEditor(
        IControlStructureConstants.CONTROLSTRUCTURE_SHOW_LISTOFCA_BORDER,
        "Show the border of the list of control action component",
        this.getFieldEditorParent());
