...
public class CSConnectionModeProvider extends AbstractSourceProvider
  ...
  public Map<String, Object> getCurrentState() {
    ...
    f = Activator.getDefault().getPreferenceStore()
        .getBoolean(IControlStructureConstants.CONTROLSTRUCTURE_SHOW_LISTOFCA_BORDER);
  ...
  public void propertyChange(PropertyChangeEvent event) {
    ...
    if (event.getProperty()
        .equals(IControlStructureConstants.CONTROLSTRUCTURE_INDIVIDUAL_CONNECTIONS)) {
      ...
      if (part instanceof IControlStructureEditor
          && ((IControlStructureEditor) part).getGraphicalViewer().getEditDomain()
              .getActiveTool() instanceof ConnectionCreationTool) {
      ...
      fireSourceChanged(ISources.WORKBENCH, CSConnectionModeProvider.PROCESS_MODEL_BORDER,
          newValue);

    } else if (event.getProperty()
        .equals(IControlStructureConstants.CONTROLSTRUCTURE_SHOW_LISTOFCA_BORDER)) {
