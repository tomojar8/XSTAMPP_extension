  ...
  public Object execute(ExecutionEvent event) throws ExecutionException {
    if (Activator.getDefault().getPreferenceStore()
      ...
      Activator.getDefault().getPreferenceStore().setValue(
          IControlStructureConstants.CONTROLSTRUCTURE_INDIVIDUAL_CONNECTIONS, Boolean.FALSE);
    } else {
      Activator.getDefault().getPreferenceStore().setValue(
          IControlStructureConstants.CONTROLSTRUCTURE_INDIVIDUAL_CONNECTIONS, Boolean.TRUE);
    }
    return null;
  }
