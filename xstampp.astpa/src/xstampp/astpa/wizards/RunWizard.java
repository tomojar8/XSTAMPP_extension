...
public class RunWizard extends AbstractExportWizard {
  ...
  public boolean performFinish() {
    ...
    folders.put(new File(outputDir + File.separator + Run.IMAGE_DIR),
        this.page.getImgChoice() || this.page.getReportChoice());
    ...
    Run runjob = new Run(this.page.getProjectName(), outputDir + File.separator,
  ...
  private class RunPage extends PdfExportPage {
    ...
    public void createControl(Composite parent) {
      ...
      this.reportCheckbox = addFormatWidget(exportScope, checkBoxData, Messages.STPAPDFReport,
          true);
