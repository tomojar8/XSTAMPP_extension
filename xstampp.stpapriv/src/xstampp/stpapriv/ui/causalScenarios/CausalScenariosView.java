...
package xstampp.stpapriv.ui.causalScenarios;
...
public class CausalScenariosView extends AbstractFilteredEditor {
	private static final String ID = "xstampp.stpapriv.ui.causalScenarios";
	private static final String UCA="Privacy-compromising control actions";

  private static final String PREFIX = "S1.";
  protected String[] columns = new String[] { "ID","Causal Scenario","Privacy Constraint" };
...
//      }
  ...
  protected void updateFilter() {
    ...
    for(ICorrespondingUnsafeControlAction uca: dataInterface.getAllUnsafeControlActions()) {
      ucaNames[index]= "PCA1."+dataInterface.getUCANumber(uca.getId()) + " - "
                      + uca.getDescription();
