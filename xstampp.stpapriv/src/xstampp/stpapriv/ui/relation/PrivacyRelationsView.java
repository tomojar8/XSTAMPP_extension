...
public class PrivacyRelationsView extends ViewPart {
  ...
  /**
   * @return String array that contains all headers for the columns of the control actions table
   *         that contains all stored control actions
   */
  protected String[] getCA_PROPS_COLUMNS() {
    return new String[] { CONTROL_ACTIONS, UNSECURE_CONTROL_ACTIONS, PRIVACY_CRITICAL,
        SECURITY_CRITICAL, SAFETY_CRITICAL, COMMENTS };
  }
  ...
  public void createPartControl(Composite parent) {
    ...
    mainTable = new ControlTable(xstpaTableComposite, getCA_PROPS_COLUMNS());
