...
public class EntryCellModifier implements ICellModifier {
	...
	public Object getValue(Object element, String property) {
		...
		} else if (property.equals("Privacy related")) {
	...
	public void modify(Object element, String property, Object value) {
		...
		if (entry.getIdCompare()[0] != 0) {
			if (property.equals("Safety related")) {
				...
				entry.setPrivate(!entry.isPrivate());
				model.setUCAPrivacyCritical(entry.getId(), entry.isPrivate());
			}

			viewer.setInput(model.getConstraintController().getValuesList());
			label.setText("Privacy related: " + model.getConstraintController().getPrivateValueCount()
					+ "Security related: " + model.getConstraintController().getSecureValueCount()
					+ "  Safety related: " + model.getConstraintController().getSafeValueCount() + "  All three: "
