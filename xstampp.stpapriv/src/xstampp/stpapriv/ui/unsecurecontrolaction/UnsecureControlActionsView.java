...
public class UnsecureControlActionsView extends UnsafeControlActionsView{
  ...
  public static final String UCA1 = "PCA1.";
  /**
	 * ViewPart ID.
	 */
	public static final String ID = "stpapriv.steps.step2_2"; //$NON-NLS-1$

	private static final String CA_FILTER="Control Action"; //$NON-NLS-1$
	private static final String UCA_FILTER="Privacy-compromising Control Actions"; //$NON-NLS-1$
	private static final String UCAID_FILTER="PCA ID"; //$NON-NLS-1$
  ...
  public UnsecureControlActionsView(String[] columns, boolean useFilter) {
	...
	public DeleteGridEntryAction<IUnsafeControlActionDataModel> getDeleteAction() {
	  return new DeleteUcaAction(getGridWrapper(), getDataModel(),PrivMessages.UnsecureControlActions,UCA1);
	}
  ...
  private boolean addUCAEntry(List<IUnsafeControlAction> ucaList, int i, int columnIndex,
	...
	public String getTitle() {
		return "Privacy-compromising Control Actions Table"; //$NON-NLS-1$
	}
