...
package xstampp.stpapriv.util.commands;
...
public class NewProject extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		String nameParam = event.getParameter("stpapriv.new.name"); //$NON-NLS-1$
		String pathParam = event.getParameter("stpapriv.new.path"); //$NON-NLS-1$
