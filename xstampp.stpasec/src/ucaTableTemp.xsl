			...
			<fo:table-body>
				...
				<fo:table-row>
					<fo:table-cell padding="2px">
						<fo:block font-size="8pt">Created with STPA-Sec</fo:block>
					</fo:table-cell>
				</fo:table-row>
			</fo:table-body>
		</fo:table>
           ...
           <xsl:attribute name="font-size"><xsl:value-of select="$headSize" />pt</xsl:attribute>
			<!-- Sets the PDF-Theme-Color -->
				...
				<fo:table-row>
					...
					<fo:table-cell padding="3px">
						<fo:block font-weight="bold">Related Losses</fo:block>
					</fo:table-cell>
				</fo:table-row>
			</fo:table-header>
	...
	<fo:table border="none" space-after="30pt">
		...
		<fo:table-header border="none" background-color="#1A277A"
           ...
           <xsl:attribute name="font-size"><xsl:value-of select="$headSize" />pt</xsl:attribute>
					...
					<fo:table-cell padding="3px">
						<fo:block font-weight="bold">Security Constraint</fo:block>
					</fo:table-cell>
					<fo:table-cell padding="3px">
						<fo:block font-weight="bold">Description</fo:block>
					</fo:table-cell>
		...
		<fo:table-header border="none" background-color="#1A277A"
           ...
           <xsl:attribute name="font-size"><xsl:value-of select="$headSize" />pt</xsl:attribute>
			<!-- Sets the PDF-Theme-Color -->
				...
				<fo:table-row>
					<fo:table-cell padding="3px">
						<fo:block font-weight="bold">STPA-Sec Step</fo:block>
					</fo:table-cell>
					<fo:table-cell padding="3px">
						<fo:block font-weight="bold">ID</fo:block>
					</fo:table-cell>
			...
			<fo:table-header border="none" background-color="#1A277A"
				...
				<fo:table-row>
					...
					<fo:table-cell padding="3px">
						<fo:block font-weight="bold">
                                 <xsl:attribute name="font-size"><xsl:value-of select="$headSize" />pt</xsl:attribute>
						Corresponding Security Constraints
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
			</fo:table-header>
											...
											<fo:block font-weight="bold">
												<fo:table border="none" space-after="30pt">
													...
													<fo:table-header border="none" background-color="#1A277A"
														...
														<fo:table-row>
															<fo:table-cell>
																<fo:block font-weight="bold">Unsecure Control Action</fo:block>
															</fo:table-cell>
															<fo:table-cell>
