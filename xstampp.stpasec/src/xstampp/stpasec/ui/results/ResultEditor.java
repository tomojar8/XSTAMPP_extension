...
import xstampp.stpasec.diagram.DiagramView;
import xstampp.stpasec.ui.relation.SecView;
...
public class ResultEditor extends StandartEditorPart implements Observer {
  ...
  public static final String ID = "stpasec.steps.step3_4";
              ...
              try {
                ...
                if (view == null) {
                  view = (DiagramView) PlatformUI.getWorkbench().getActiveWorkbenchWindow()
                      .getActivePage().showView("xstampp.stpasec.diagram");
