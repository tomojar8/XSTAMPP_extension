 ...
 *******************************************************************************/
package xstampp.stpasec.wizards;
...
public class NewProjectWizard extends Wizard implements INewWizard {
	...
	public boolean performFinish() {
		...
		values.put("stpasec.new.name", this.page.getNewProjectName()); //$NON-NLS-1$
		values.put("stpasec.new.path", this.page.getNewProjectPath()); //$NON-NLS-1$
		STPAPluginUtils.executeParaCommand("stpasec.commands.new", values); //$NON-NLS-1$
		return true;
	}
