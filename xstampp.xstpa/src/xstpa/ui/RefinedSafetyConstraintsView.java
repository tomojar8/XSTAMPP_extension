...
public class RefinedSafetyConstraintsView extends AbstractFilteredTableView {
  ...
  public RefinedSafetyConstraintsView() {
    super(new RefinedEntryFilter(), new String[] { Messages.ID, "Refined Unsafe Control Actions",
        Messages.ID, "Refined Safety Constraints" });
  ...
  protected List<?> getInput() {
    ...
    List<AbstractLTLProvider> allRUCA = ((IExtendedDataModel) getDataInterface()).getExtendedDataController()
