...
public class RefinedSafetyConstraintsView extends AbstractFilteredTableView {
	...
	public RefinedSafetyConstraintsView() {
		super(new RefinedEntryFilter(), new String[] { Messages.ID, "Refined Privacy-Compromising Control Actions", Messages.ID,
	...
	protected List<?> getInput() {
		...
		List<AbstractLTLProvider> allRUCA = ((IExtendedDataModel)getDataInterface()).getExtendedDataController().getAllScenarios(true,false,false);
	...
	public String getTitle() {
		return "Refined Privacy Constraints";
	}
	...
	protected CSCLabelProvider getColumnProvider(int columnIndex) {
		...
		case 0:
			return new CSCLabelProvider() {
				...
				public String getText(Object element) {
					return "RPR1." + ((AbstractLTLProvider) element).getNumber();
				}
			};
		case 1:
			return new CSCLabelProvider() {
		...
		case 2:
			return new CSCLabelProvider() {
				@Override
				public String getText(Object element) {
					return "PC2." + ((AbstractLTLProvider) element).getNumber();
				}
			};
		case 3:
			return new CSCLabelProvider() {
