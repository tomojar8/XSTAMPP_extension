...
public class View extends ViewPart {
  ...
  public static final String SAFETY_CRITICAL = "Privacy Critical";

  public static final String CONTROLLER_WITH_PM_CLASS = "xstpapriv.ControllerWithPMEntry";

  public static final String CA_ENTRY_CLASS = "xstpapriv.ControlActionEntrys";

  public static final String PM_VALUE_CLASS = "xstpapriv.ProcessModelVariables";
  ...
  public static final String IS_HAZARDOUS = "Vulnerable?";

  public static final String HAZ_IF_ANYTIME = "Vulnerable if provided anytime";

  /**
   * String <i>Hazardous if provided to early</i>
   */
  public static final String HAZ_IF_EARLY = "Vulnerable if provided to early";

  public static final String HAZ_IF_LATE = "Vulnerable if provided to late";

  public static final String LTL_RULES = "LTL Formula";

  public static final String UCA = "Related Privacy-Compormising CA";

  public static final String REL_HAZ = "Linked Vulnerability";
  ...
  /**
   * String array that contains all headers for the columns of the properties table that shows all
   * process values
   */
  ...
  /**
   * String array that contains all headers for the columns of the control actions table that
   * contains all stored control actions
   */
  public static final String[] CA_PROPS_COLUMNS = { CONTROL_ACTIONS, SAFETY_CRITICAL, COMMENTS };

  /**
   * String array that contains all headers for the columns of the refined safety constraints table
   * that cpntains all process values
   */
  public static final String[] RS_PROPS_COLUMS = { ENTRY_ID, CONTROL_ACTIONS, CONTEXT,
      CRITICAL_COMBI, UCA, REL_HAZ, REFINED_RULES };

  // static fields to hold the images
  public static final Image CHECKED = Activator.getImageDescriptor("icons/checked.gif")
      .createImage();

  public static final Image UNCHECKED = Activator.getImageDescriptor("icons/unchecked.gif")
      .createImage();
  ...
  public static final Image SETTINGS = Activator.getImageDescriptor("icons/Settings.png")
      .createImage();

  public static final Image HEADER = Activator.getImageDescriptor("icons/tableheader1.jpg")
      .createImage();

  public static final Image LTL = Activator.getImageDescriptor("icons/ltl.png").createImage();

  public static final Image EXPORT = Activator.getImageDescriptor("icons/run_pdf.png")
      .createImage();

  public static final Image CHECK_CONFLICTS = Activator
      .getImageDescriptor("icons/check_conflicts.png").createImage();

  public static final Image LOGO = Activator.getImageDescriptor("icons/logo.png").createImage();

  public static final Image GENERATE = Activator.getImageDescriptor("icons/generate.png")
      .createImage();
  ...
  public View(IDataModel model) {
    if (model instanceof IExtendedDataModel) {
      dataController = new XSTPADataController((IExtendedDataModel) model);
    }
  }
  ...
  public void createPartControl(Composite parent) {
    ...
    if (dataController == null && part != null && part instanceof StandartEditorPart) {
      XSTPADataController controller = Activator
  ...
  private void openTable(AbstractTableComposite table, Button button) {
    for (Button btn : tableButtons) {
      btn.setBackground(Display.getDefault().getSystemColor(SWT.COLOR_LIST_BACKGROUND));
      btn.setForeground(Display.getDefault().getSystemColor(SWT.COLOR_LIST_FOREGROUND));
    }
    ...
    if (button != null) {
      button.setBackground(Display.getDefault().getSystemColor(SWT.COLOR_LIST_SELECTION));
      button.setForeground(Display.getDefault().getSystemColor(SWT.COLOR_LIST_SELECTION_TEXT));
    }
  }
