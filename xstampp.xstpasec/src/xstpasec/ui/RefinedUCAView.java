...
public class RefinedUCAView extends CommonGridView<IExtendedDataModel> {
	...
	private static final String UCA="refined unsecure control actions";
  private static final String[] columns = new String[] {
	...
	private static final String ID = "xstpasec.editors.refinedUCA";
	...
	public String getTitle() {
		return "Refined Unsecure Control Actions";
	}
	@Override
