...
import xstpasec.Activator;

public class View extends ViewPart {
  public static final String ID = "xstpasec.view.contextTables";
  ...
  public static final String SAFETY_CRITICAL = "Security Critical";

  public static final String CONTROLLER_WITH_PM_CLASS = "xstpasec.ControllerWithPMEntry";

  public static final String CA_ENTRY_CLASS = "xstpasec.ControlActionEntrys";

  public static final String PM_VALUE_CLASS = "xstpasec.ProcessModelVariables";
  ...
  public static final String UCA = "Related Unsecure CA";
