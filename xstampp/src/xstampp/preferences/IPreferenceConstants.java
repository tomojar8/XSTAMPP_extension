...
public interface IPreferenceConstants {
  ...
  /**
   * Constant for sorting the navigation depending on the project extension 1
   * for alphabetical order -1 for counter alphabetical and 0 for no sorting.
   */
  String NAVIGATION_EXTENSION_SORT = "navigationExtensionSort"; //$NON-NLS-1$

  /**
   * Constant for sorting the navigation depending on the project name 1 for
   * alphabetical order -1 for counter alphabetical and 0 for no sorting.
   */
   ...
   */
  String RECENT_PROJECTS = "recentProjects"; //$NON-NLS-1$
  ...
  /**
   * Constant that stored the decision whether the last workspace should be used
   * or if the user should be ask every time the program starts
   */
