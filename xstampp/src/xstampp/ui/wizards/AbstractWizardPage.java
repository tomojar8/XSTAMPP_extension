...
public abstract class AbstractWizardPage extends WizardPage {
   ...
   *          suggestion for the name that should be choosen for the file
   * 
   */
  ...
  /**
   * a class which can be used by every child to add a Comosite to the editor
   * page with which the user can than choose a file path
   *
   * @author Lukas Balzer
   *
   */
  protected final class PathComposite extends Composite implements SelectionListener {
    ...
    /**
     * calls
     * {@link #AbstractWizardPage(String[], String[], Composite, int, String)}
     * with <code>Messages.Destination</code> as name
     *
     * @author Lukas Balzer
     *
     * @param filter
     *          a string array containing the filter extensionsBsp.:
     *          {"*.haz","*.hazx"}
     * @param parent
     *          the parent composite
     * @param style
     *          the style, must be one of the constants defined in PathComposite
     */
    ...
    public void widgetSelected(SelectionEvent e) {
      ...
      AbstractWizardPage.this.setPageComplete(AbstractWizardPage.this.checkFinish());
    }
  ...
  protected final class ColorChooser extends Composite {
    ...
    /**
     * This constructs a Composite containing Elements for choosing a color and
     * storing the value in a preference store
     * 
     * @author Lukas Balzer
     * 
     * @param parent
     ...
     * @param constant
     *          The IPreferenceConstants to which the color is linked in the
     *          preference store
     * 
     * @see Composite#Composite(Composite, int)
     */
